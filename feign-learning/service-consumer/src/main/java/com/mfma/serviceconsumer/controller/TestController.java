...
import com.mfma.serviceconsumer.service.TestCommonService;
...
public class TestController {
	...
	public TestController(
			@Qualifier(value = "testTemplate") RestTemplate restTemplate, EurekaClient eurekaClient, DiscoveryClient discoveryClient,
