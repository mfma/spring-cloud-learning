package com.mfma.serviceconsumer1.controller;
...
public class TestController {
	...
	private String RESULT_MESSAGE="service-consumer-1 call service----";
	...
	public String test2() {
		log.debug("service-consumer-1-尝试使用RestTemplate通过Eureka间接访问服务");
	...
	@GetMapping("/test8")
	public String test8() {
		log.debug("service-consumer-1-测试单独hystrix");
